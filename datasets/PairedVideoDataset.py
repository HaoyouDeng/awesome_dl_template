from datasets.UnpairedVideoDataset import UnpairedVideoDataset


class PairedVideoDataset(UnpairedVideoDataset):
    def __init__(
        self, folders_a, folders_b, clip_len, transform, recursive=True, return_image_path=False
    ):
        super(PairedVideoDataset, self).__init__(
            folders_a, folders_b, clip_len, transform, recursive, return_image_path
        )
